...
parser = argparse.ArgumentParser(
    description='Provide IP-address for range of IP-addresses',
...
try:
    ...
    print("Something else is wrong - %s" % e)
    sys.exit(2)
...
while (i > 16):
    ...
    print("Range for", n, ":", n[0], "-", n[-1], '(',
          str(len(list(n.hosts()))), ')', str(n.num_addresses))
    i -= 1
