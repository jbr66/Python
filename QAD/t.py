...
REGION_TO_ARN = {
    "us-east-2":    "arn:aws:ram:us-east-2:852828256769:resource-share/495153f3-bc80-4c58-81fa-3b89b05833bc",
    "eu-central-1": "arn:aws:ram:eu-central-1:852828256769:resource-share/7031d4d2-c30d-4ee0-ac16-730543e3f191",
...
def get_args() -> argparse.Namespace:
	...
	parser.add_argument('--attach-tgw', dest='attach',
		help='Attaches the destination VPC to the TGW', action='store_true')
	parser.add_argument('--detach-tgw', dest='detach',
		help='Detaches the destination VPC from the TGW', action='store_true')
...
if os.environ['AWS_REGION'] in REGION_TO_ARN:
	print('The Resource Share ARN for AWS_REGION %s: %s' % (os.environ['AWS_REGION'],REGION_TO_ARN[os.environ['AWS_REGION']]))
else:
